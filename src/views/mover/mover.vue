    ...
    <div class="dialog-grid">
      <div class="form-left">
        ...
        <el-form-item label="服务评分" prop="rating">
          <el-input-number v-model="moverForm.rating" :precision="1" :step="0.1" :max="5" :min="0" style="width: 100%" />
        </el-form-item>
...
import { getMoverPage, updateMoverStatus, getMoverById, updateMover } from '../../api/mover';
...
.query-form .el-form-item {
  margin-bottom: 0 !important; /* 取消下边距实现居中 */
